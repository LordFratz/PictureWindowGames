...
DumbPlaneRenderer::DumbPlaneRenderer()
{
}

DumbPlaneRenderer::DumbPlaneRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void DumbPlaneRenderer::CreateDeviceDependentResources()
{
...
void DumbPlaneRenderer::CreateWindowSizeDependentResources()
{
...
void DumbPlaneRenderer::ReleaseDeviceDependentResources()
{
	m_loadingComplete = false;
